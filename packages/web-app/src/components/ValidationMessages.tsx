...
export function ValidationMessages({ result }: ValidationMessagesProps) {
  ...
  return (
    <div className="mt-6 rounded-lg border border-amber-400/40 bg-amber-400/5 px-5 py-4">
      <p className="font-mono text-xs text-amber-300 mb-2">Warnings</p>
      <ul className="space-y-1.5 list-disc list-inside text-amber-300 text-sm">
